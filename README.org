...
** Orgmk-init
   :PROPERTIES:
   :header-args+: :tangle bin/orgmk-init
   :END:
...
** org2html
   :PROPERTIES:
   :header-args+: :tangle bin/org2html
   :END:
...
** org2latex
   :PROPERTIES:
   :header-args+: :tangle bin/org2latex
   :END:
...
** org2pdf
   :PROPERTIES:
   :header-args+: :tangle bin/org2pdf
   :END:
...
** org2beamerpdf
   :PROPERTIES:
   :header-args+: :tangle bin/org2beamerpdf
   :END:
...
** org2odt
   :PROPERTIES:
   :header-args+: :tangle bin/org2odt
   :END:
...
** org2txt
   :PROPERTIES:
   :header-args+: :tangle bin/org2txt
   :END:
...
** org2gfm
    :PROPERTIES:
    :header-args+: :tangle bin/org2gfm
    :END:
...
** Orgmk-update-src-check-diff
   :PROPERTIES:
   :header-args+: :tangle bin/orgmk-update-src-check-diff
   :END:
...
** org-tangle
   :PROPERTIES:
   :header-args+: :tangle bin/org-tangle
   :END:
